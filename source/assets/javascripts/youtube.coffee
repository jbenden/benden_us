$ ->
  ...
  $.getJSON "https://gdata.youtube.com/feeds/api/users/JBenden1976/uploads?v=2&max-results=1&alt=jsonc", (response) ->
    console.log response.data.items[0]

  # Fetches my YouTube user. Prints out the subscriber count.
  $.getJSON "https://gdata.youtube.com/feeds/api/users/JBenden1976?v=2&alt=json", (response) ->
